...
class PageVariant extends ConfigEntityBase implements PageVariantInterface {
  ...
  protected static function invalidateTagsOnDelete(EntityTypeInterface $entity_type, array $entities) {
    ...
    foreach ($entities as $entity) {
      // Pages may get deleted before PageVariants and so $entity->getPage() will
      // throw an exception. If the page has already been deleted or there is no
      // page set, it's cache tags will already be invalidated, so we can safely
      // catch and ignore.
      try {
