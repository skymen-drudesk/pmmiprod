...
/**
 * Provides a PMMISSOPreventPasswordResetSubscriber.
 */
class PMMISSOPreventPasswordResetSubscriber implements EventSubscriberInterface {
  ...
  public function alter(RouteBuildEvent $event) {
    if ($this->configFactory->get('pmmi_sso.settings')->get('user_accounts.restrict_password_management')) {
