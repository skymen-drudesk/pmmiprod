...
/**
 * Provides the reports import storage for fetched content using a key value store.
 */
class ReportsImportStorage implements ReportsImportStorageInterface {
  ...
  public function __construct(KeyValueFactoryInterface $key_value_factory) {
    $this->keyValueStore = $key_value_factory->get('reports_import');
  }
