...
/**
 * Builds the PMMI Admin Panel Agent Search block.
 *
 * @Block(
 *  id = "pmmi_admin_panel_agent_search_block",
 *  admin_label = @Translation("PMMI Admin Panel Agent Search block"),
 *  category = @Translation("PMMI Search")
 * )
 */
class PMMIAdminPanelAgentSearchBlock extends BlockBase implements ContainerFactoryPluginInterface {
